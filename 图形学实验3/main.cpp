...
extern void DrawBezier_By_de_Casteljau(int g_iCtrlPntNum, wcPt3D	g_pCtrlPoints[]);
...
void ModifyScreenImage()
{
	...
	if (g_bFinish)
	{
		...
		//请同学们实现 DrawBezier_By_de_Casteljau函数
		setLineType(SOLID_LINE);
		DrawBezier_By_de_Casteljau(g_iCtrlPntNum, g_pCtrlPoints);
	}
}
